...
class TestInferenceUseCase:
    ...
    def test_call_returns_expected_response(
        ...
        use_case = InferenceUseCase(mock_context_reader, mock_chat_adapter, mock_logger)
    ...
    def test_error_in_context_reader_is_handled(self, mock_chat_adapter: ChatAdapterPort[Iterator[str]]) -> None:
